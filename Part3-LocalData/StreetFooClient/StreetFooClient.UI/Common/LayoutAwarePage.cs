...
namespace StreetFooClient.UI.Common
{
    /// <summary>
    ...
    public class LayoutAwarePage : Page
    {
        ...
        protected T GetDataModelValue<T>([CallerMemberName] string name = null)
        {
            object value = null;
            if (this.DefaultViewModel.ContainsKey(name))
                value = this.DefaultViewModel[name];
